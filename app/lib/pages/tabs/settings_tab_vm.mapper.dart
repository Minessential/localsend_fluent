...
class SettingsTabVmMapper extends ClassMapperBase<SettingsTabVm> {
  ...
  static const Field<SettingsTabVm, Function> _f$onChangeLanguage =
      Field('onChangeLanguage', _$onChangeLanguage, arg: _arg$onChangeLanguage);
...
class _SettingsTabVmCopyWithImpl<$R, $Out>
  ...
  SettingsTabVm $make(CopyWithData data) => SettingsTabVm(
      ...
      onChangeLanguage:
          data.get(#onChangeLanguage, or: $value.onChangeLanguage),
      onToggleAutoStart:
