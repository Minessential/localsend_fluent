...
class Translations$settingsTab$zh_CN extends Translations$settingsTab$en {
  ...
  String get title => '设置';
  @override
  late final Translations$settingsTab$toggleSwitch$zh_CN toggleSwitch = Translations$settingsTab$toggleSwitch$zh_CN.internal(_root);
  @override
...
class Translations$settingsTab$toggleSwitch$zh_CN extends Translations$settingsTab$toggleSwitch$en {
  Translations$settingsTab$toggleSwitch$zh_CN.internal(TranslationsZhCn root) : this._root = root, super.internal(root);
