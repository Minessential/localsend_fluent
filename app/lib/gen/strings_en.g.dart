...
class Translations$settingsTab$en {
  ...
  late final Translations$settingsTab$toggleSwitch$en toggleSwitch = Translations$settingsTab$toggleSwitch$en.internal(_root);
...
class Translations$settingsTab$toggleSwitch$en {
  Translations$settingsTab$toggleSwitch$en.internal(this._root);
